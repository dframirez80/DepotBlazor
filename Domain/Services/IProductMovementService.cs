...
namespace Domain.Services
{
    public interface IProductMovementService
    {
        ...
        /// </remarks>
        Task<Response<List<ProductMovementDto>>> GetAllAsync();
        #endregion
        ...
        /// </remarks>
        Task<Response<ProductMovementDto>> CreateAsync(ProductMovementDto entityDto);
        #endregion
        ...
        /// </remarks>
        Task<Response<ProductMovementDto>> UpdateAsync(ProductMovementDto entityDto);
        #endregion
